#!/usr/bin/env python3
"""
Cross-platform script to run Hello Service
...
def show_help():
    ...
    colored_print("🚀 Hello Service Runner", Colors.CYAN)
    print("")
    colored_print("Usage:", Colors.YELLOW)
    print("  python run_hello_service.py           # Run with system Python")
    print("  python run_hello_service.py --venv    # Run with virtual environment")
    print("  python run_hello_service.py --help    # Show this help")
    print("")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Run Hello Service', add_help=False)
    ...
    colored_print("🚀 Starting Hello Service...", Colors.GREEN)
    
    # Get script directory
    script_dir = os.path.dirname(os.path.abspath(__file__))
    service_dir = os.path.join(script_dir, "services", "hello-service")
    ...
    print("")
    colored_print("🌟 Starting Hello Service...", Colors.MAGENTA)
    colored_print("🔗 Service URL: http://localhost:8001", Colors.CYAN)
    colored_print("📚 API Documentation: http://localhost:8001/docs", Colors.CYAN)
    colored_print("❤️  Health Check: http://localhost:8001/health", Colors.CYAN)
    ...
    try:
        ...
        print("")
        colored_print("👋 Hello Service stopped", Colors.YELLOW)
